    ...
    return [
      ...
      css`
        ...
        .scroll-demo {
          ...
          --dw-surface-scroller-padding: 16px;
        }
      `
    ];
  }
  ...
  render() {
    ...
    return html`
      ...
      <div style="display: flex;">
        <div>
        <div>&nbsp;&nbsp;&nbsp;Using Composition</div>
        <dw-surface class="scroll-demo" elevation="3" interactive style="width: 300px;">
          <div>
